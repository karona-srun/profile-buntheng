                                ...
                                <div class="col-md-12">
                                    <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label> </label>
                                        <input type="text" name="title_en" class="form-control" placeholder="Post" required value="{{ old('title_en')}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Title (as Khmer)</label>
                                            <input type="text" name="title_kh" class="form-control" placeholder="Post" required value="{{ old('title_kh')}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control summernote" name="body_en" id="exampleFormControlTextarea1" rows="3">{{ old('body_en')}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Body (as Khmer)</label>
                                            <textarea class="form-control summernote" name="body_kh" id="exampleFormControlTextarea1" rows="3">{{ old('body_kh')}}</textarea>
                                        </div>
                                        <div class="form-group">
