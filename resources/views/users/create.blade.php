                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter username" value="{{ old('name') }}" required autocomplete="name">
                                    <p><small class="text-red">{{ $errors->first('username') }}</small></p>
                                </div>
                                <div class="form-group">
                                    <label for="basicInput">Email</label>
                                    <input type="email" class="form-control" name="email" placeholder="Enter your email address" value="{{ old('email') }}" required autocomplete="email">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <p><small class="text-red">{{ $errors->first('password') }}</small></p>
                                </div>
                                <div class="form-group">
