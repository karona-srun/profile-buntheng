...
(function($) {
    "use strict";
    var autoplay, bgcolor, blockleft, blocknum, blockshare, blocktitle, blockdescription, border, core, container, content, dest, extraCss,
        framewidth, frameheight, gallItems, infinigall, items, keyNavigationDisabled, margine, numeratio,
        overlayColor, overlay, title, description, thisgall, thenext, theprev, nextok, prevok, preloader, $preloader, navigation,
    ...
    $.fn.extend({
        ...
        venobox: function(options) {
                ...
                return this.each(function() {
                    ...
                    obj.data('descattr', option.descattr);
                    ...
                    obj.on('click', function(e) {
                        ...
                        description = obj.data('desc') || obj.attr('desc');
                        ...
                        overlay.animate({ opacity: 1 }, 250, function() {
                            ...
                            if (obj.data('vbtype') == 'iframe') {
                                ...
                                content.html('<div class="vbox-content vbox-animated" style="opacity: 1; margin: 30px 0px;">' +
                                    '<div class="row justify-content-center" style="opacity: 1;">' +
                                    '<div class="col-md-6">' +
                    ...
                    function navigateGall(destination) {
                        ...
                        description = destination.data('desc') || destination.attr('desc');
